...
# ==================================================
# Struktur: helmanopijaniheidy.thesis/Data/DataModels/
DATASET_DIR = (
    BASE_DIR
    / ".."
    / ".."
...
# URL Download Baru
ZIP_URL = "https://serverdorisjuarsafoldershare.dorisjuarsa.com/Jeni/runs_frcnn.zip"

# Nama file tujuan berdasarkan URL
zip_filename = "runs_frcnn.zip"

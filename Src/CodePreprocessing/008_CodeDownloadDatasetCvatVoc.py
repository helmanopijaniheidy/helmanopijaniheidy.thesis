...
"""
001_CodeDownloadDatasetCvatVoc.py
...
# URL Download Baru
ZIP_URL = "https://serverdorisjuarsafoldershare.dorisjuarsa.com/Jeni/RBC_WBC_VOC_DATASET.zip"

# Nama file tujuan berdasarkan URL
zip_filename = "RBC_WBC_VOC_DATASET.zip"

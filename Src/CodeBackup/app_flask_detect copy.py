...
# label:color_rgb (sesuai labelmap kamu)
# id 0 = background (tidak dipakai)
LABEL_MAP = {
    1: ("RBC", (255, 0, 0)),   # RGB
    2: ("WBC", (0, 0, 255)),   # RGB
}
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-4">
        <div class="glass p-3 p-md-4 h-100">
          ...
          <form id="detectForm" method="POST" enctype="multipart/form-data">
            ...
            <button id="detectBtn" type="submit" class="btn btn-info w-100 fw-semibold">
          ...
          <div class="d-flex flex-column gap-2">
            ...
            <div class="stat-pill d-flex justify-content-between align-items-center">
              <div class="muted tiny"><i class="bi bi-person-fill text-success"></i> WBC</div>
      ...
      <div class="col-12 col-lg-8">
        ...
        <div class="muted tiny mt-3">
          ...
          Catatan: server ini berjalan lokal/jaringan lab (tanpa Apache/Nginx). Cocok untuk pengujian & demonstrasi tesis.
        </div>
      </div>
    </div>
...
if __name__ == "__main__":
    # Jika mau akses dari PC lain, gunakan host="0.0.0.0"
